...
public class WechatScanView2 extends View implements ValueAnimator.AnimatorUpdateListener{
	...
	public WechatScanView2(Context context) {
		super(context);
		init(context);
	}

	public WechatScanView2(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public WechatScanView2(Context context, AttributeSet attrs, int defStyleAttr) {
